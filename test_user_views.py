...
# Don't have WTForms use CSRF at all to avoid testing issues
...
class UserViewTestCase(TestCase):
    ...
    def setup_likes(self):
        """Set up messages and likes for testing"""
    ...
    def test_user_show_with_likes(self):
        """Test if likes are displayed on show page"""
        self.setup_likes()
    ...
    def test_remove_like(self):
        """Test if user can remove a like"""
    ...
    def test_unauthenticated_like(self):
        """Test when unauthenticated user likes a message  """
        self.setup_likes()
